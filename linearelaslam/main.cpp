...
MPI_Init(&argc, &argv);
    ...
    //interface->compute_mean_cauchy_stress(*interface->solution, path, true, true);
    interface->recover_cauchy_stress(path,seed);
    interface->compute_deformation(*interface->solutionm,path,true,true);
