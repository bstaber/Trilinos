#ifndef ARTERIES_MODELC_GMRF_NEUMANN_HPP
#define ARTERIES_MODELC_GMRF_NEUMANN_HPP
...
class NeumannInnerSurface_StochasticPolyconvexHGO : public hyperelasticity_setup
{
public:
