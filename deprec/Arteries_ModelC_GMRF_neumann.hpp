...
public:
    ...
    void get_media(unsigned int & n_cells, unsigned int & n_nodes, std::string & path){
        ...
        connectivity_file_med.open(path+"connectivity_p1.txt");
        
        c1_gmrf.Resize(n_nodes);
        c2_gmrf.Resize(n_nodes);
        u1_gmrf.Resize(n_nodes);
        mu4_gmrf.Resize(n_nodes);
    ...
    void get_material_parameters(unsigned int & e_lid, unsigned int & gp){
        ...
        c1 = N(0)*c1_gmrf(cells_nodes_p1_med(4*e_gid)) + N(1)*c1_gmrf(cells_nodes_p1_med(4*e_gid+1)) + N(2)*c1_gmrf(cells_nodes_p1_med(4*e_gid+2)) + N(4)*c1_gmrf(cells_nodes_p1_med(4*e_gid+3));
        c2 = N(0)*c2_gmrf(cells_nodes_p1_med(4*e_gid)) + N(1)*c2_gmrf(cells_nodes_p1_med(4*e_gid+1)) + N(2)*c2_gmrf(cells_nodes_p1_med(4*e_gid+2)) + N(4)*c2_gmrf(cells_nodes_p1_med(4*e_gid+3));
        u1 = N(0)*u1_gmrf(cells_nodes_p1_med(4*e_gid)) + N(1)*u1_gmrf(cells_nodes_p1_med(4*e_gid+1)) + N(2)*u1_gmrf(cells_nodes_p1_med(4*e_gid+2)) + N(4)*u1_gmrf(cells_nodes_p1_med(4*e_gid+3));
        mu4 = N(0)*mu4_gmrf(cells_nodes_p1_med(4*e_gid)) + N(1)*mu4_gmrf(cells_nodes_p1_med(4*e_gid+1)) + N(2)*mu4_gmrf(cells_nodes_p1_med(4*e_gid+2)) + N(4)*mu4_gmrf(cells_nodes_p1_med(4*e_gid+3));
    ...
    Epetra_SerialDenseVector c1_gmrf;
    Epetra_SerialDenseVector c2_gmrf;
    Epetra_SerialDenseVector u1_gmrf;
    Epetra_SerialDenseVector mu4_gmrf;
